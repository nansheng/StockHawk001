...
public class QuoteCursorAdapter extends CursorRecyclerViewAdapter<QuoteCursorAdapter.ViewHolder>
  ...
  public void onBindViewHolder(final ViewHolder viewHolder, final Cursor cursor){
    ...
    if (Utils.showPercent){
      ...
      String dollarChange = cursor.getString(cursor.getColumnIndex("change"));
      viewHolder.change.setText(dollarChange);
      viewHolder.change.setContentDescription(mContext.getString(R.string.a11y_change, dollarChange));
    }
  }
